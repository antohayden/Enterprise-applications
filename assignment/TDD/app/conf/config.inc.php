...
define("ACTION_GET_STUDENTS_NATIONALITY", 43);
define("ACTION_GET_TASKS", 51);
define("ACTION_GET_TASK_BY_ID", 52);
define("ACTION_GET_TASKS_BY_COURSE_ID", 53);
...
define("ACTION_GET_QUESTIONNAIRES_BY_STUDENT_ID", 63);
define("ACTION_GET_TASK_ID_OF_QUESTIONNAIRES", 64);
define("ACTION_GET_COURSES", 70);
define("ACTION_GET_COURSE_BY_ID", 71);
